...
public class SemesterRegistrationDaoImplementation implements SemesterRegistrationDaoInterface {
    ...
    /**
     * Method to check eligibility of student for course
     * @param studentId
     * @return  boolean
     */
    ...
    /**
     * Method to check if the course can be dropped
     * @param studentId
     * @param courseId
     * @param semesterId
     * @return  boolean
    ...
    /**
     * Method to check of the course exists
     * @param courseId
     * @param studentId
     * @return  boolean
     */
   ...
   public void changeCourseSeats(String courseId, int change) {
     ...
     * @param studentId
     * @param isPrimary
     * @throws CourseNotFoundException,CourseSeatsUnavailableException,CourseExistsInCartException
     * @return  boolean
     */
